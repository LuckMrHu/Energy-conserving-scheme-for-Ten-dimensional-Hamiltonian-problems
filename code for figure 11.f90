...
open(10,file=file1)
number=0d0
call initial(sx,sy,sz,cta,ctb,px,py,pz,xia,xib,n,c1,c2,w,h,t,t1,t2,ratio)
...
do 1 i=1d0,50d0,1d0
   ...
   2 call step(t,h)
	 ...
	 ft=dlog10(dabs(t2-t1)+1d-16)
	 fh=dlog10(dabs(temph-inih)+1d-16)
     fl=dlog10(dabs(templ-inil)+1d-16)
	 !fr=dlog10(dabs(r-inir)+1d-16)
	 number=number+1d0
	 write(10,*)ft,fh,fl
	 write(*,*)number
	 call inivar(sx,sy,sz,cta,ctb,px,py,pz,xia,xib,t,t1,t2)
	 h=h/ratio
1 continue
write(*,*)count
pause
...
subroutine initial(sx,sy,sz,cta,ctb,px,py,pz,xia,xib,n,c1,c2,w,h,t,t1,t2,ratio)
implicit none
real*8 sx,sy,sz,cta,ctb,px,py,pz,xia,xib,n,c1,c2,w,h,t,t1,t2,ratio
c1=1d0
c2=1d0
w=1d0
n=1d0/(w+1d0/w+2d0)
ratio=1.206792640639328637d0
h=10d0
call inivar(sx,sy,sz,cta,ctb,px,py,pz,xia,xib,t,t1,t2)
return
end subroutine

subroutine inivar(sx,sy,sz,cta,ctb,px,py,pz,xia,xib,t,t1,t2)
implicit none
real*8 sx,sy,sz,cta,ctb,px,py,pz,xia,xib,t,t1,t2
real*8 pe,e
t=0d0
t1=0d0
t2=0d0
