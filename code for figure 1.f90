...
open(30,file=file3)
call cpu_time(init)
call constant(beta,epsi,h,endt,j,k)
call initiala(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,inih,inis,num,t)
write(*,*)inih
write(*,*)inis
pause
1 do 2 i=1d0,j,k
...
subroutine constant(beta,epsi,h,endt,j,k)
implicit none
...
subroutine initiala(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,inih,inis,num,t)
implicit none
real*8 q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,inih,inis,num,t
num=0d0
t=0d0
q1=0.5d0
q2=0.4d0
