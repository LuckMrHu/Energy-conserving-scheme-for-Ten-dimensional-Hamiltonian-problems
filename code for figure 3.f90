...
character(len=20)::file2="q1p1.dat"
character(len=20)::file3="r1.dat"
character(len=20)::file4="fli.dat"
real*8 q1,q2,q3,q4,q5,p1,p2,p3,p4,p5
real*8 x1,x2,x3,x4,x5,v1,v2,v3,v4,v5
real*8 beta,epsi
real*8 h,endt
real*8::t=0d0,init=0d0,overt=0d0
real*8 inih,inis,temph,temps,fh,fs,r
...
open(40,file=file4)
call cpu_time(init)
call constant(beta,epsi,h,endt,j,k,inid)
call initiala(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,inih,inis,fli,el,num,t)
...
1 do 2 i=1d0,j,k
       call timestep(t,h)
       !call rks(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,h)
	   !call iss(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,h)
	   !call ems(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,h)
	   call ecf(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,h)
	   call ecf(x1,x2,x3,x4,x5,v1,v2,v3,v4,v5,beta,epsi,h)
	   tempd=dsqrt((q1-x1)**2d0+(q2-x2)**2d0+(q3-x3)**2d0+(p1-v1)**2d0+(p2-v2)**2d0+(p3-v3)**2d0+(q4-x4)**2d0+(q5-x5)**2d0+(p4-v4)**2d0+(p5-v5)**2d0)
	   if(tempd.ge.0.5d0)then
...
call hamiltonian(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,temph)
call norm(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,temps)
fh=dlog10(dabs(temph-inih)+1d-16)
fs=dlog10(dabs(temps-inis)+1d-16)
write(10,*)dlog10(t),fh,fs
write(20,*)t,q1,p1
write(30,*)t,dsqrt(q1**2d0+p1**2d0)
write(40,*)dlog10(t),fli
count=count+1d0
write(*,*)count
if(t.lt.endt)goto 1
call cpu_time(overt)
...
subroutine constant(beta,epsi,h,endt,j,k,inid)
implicit none
...
subroutine initiala(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,inih,inis,fli,el,num,t)
implicit none
real*8 q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,inih,inis,fli,el,num,t
el=0d0
fli=0d0
num=0d0
t=0d0
...
p4=0d0
p5=0d0
call hamiltonian(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,inih)
...
subroutine spaced(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,x1,x2,x3,x4,x5,v1,v2,v3,v4,v5,tempd)
implicit none
real*8 q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,x1,x2,x3,x4,x5,v1,v2,v3,v4,v5,tempd
tempd=((q1-x1)**2d0+(q2-x2)**2d0+(q3-x3)**2d0+(p1-v1)**2d0+(p2-v2)**2d0+(p3-v3)**2d0+(q4-x4)**2d0+(q5-x5)**2d0+(p4-v4)**2d0+(p5-v5)**2d0+1d-32)**(1d0/2d0)
return
end subroutine

subroutine orbitreform(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,x1,x2,x3,x4,x5,v1,v2,v3,v4,v5,dt,d1)
implicit none
real*8 q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,x1,x2,x3,x4,x5,v1,v2,v3,v4,v5,dt,d1
x1=q1+d1*(x1-q1)/dt
x2=q2+d1*(x2-q2)/dt
x3=q3+d1*(x3-q3)/dt
x4=q4+d1*(x4-q4)/dt
...
subroutine lyexp(inid,tempd,el,t)
implicit none
real*8 inid,tempd,el,t
el=(el+dlog(tempd/inid+1d-16))/t
return
end subroutine

subroutine fastlyindex(inid,tempd,fli,num)
implicit none
real*8 inid,tempd,fli,num
fli=num*dlog10(1d0/inid)+dlog10(tempd/inid)
return
end subroutine
...
subroutine hamiltonian(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,hami)
implicit none
...
1 z1=q1m
  ...
  z9=p4m
  z10=p5m
call hamiltonian(q10,q20,q30,q40,q50,p1m,p20,p30,p40,p50,beta,epsi,h0000010000)
call hamiltonian(q1m,q20,q30,q40,q50,p1m,p20,p30,p40,p50,beta,epsi,h1000010000)
call hamiltonian(q10,q20,q30,q40,q5m,p1m,p20,p30,p40,p5m,beta,epsi,h0000110001)
call hamiltonian(q1m,q2m,q30,q40,q50,p1m,p2m,p30,p40,p50,beta,epsi,h1100011000)
call hamiltonian(q10,q20,q30,q4m,q5m,p1m,p20,p30,p4m,p5m,beta,epsi,h0001110011)
call hamiltonian(q1m,q2m,q3m,q40,q50,p1m,p2m,p3m,p40,p50,beta,epsi,h1110011100)
call hamiltonian(q10,q20,q3m,q4m,q5m,p1m,p20,p3m,p4m,p5m,beta,epsi,h0011110111)
call hamiltonian(q1m,q2m,q3m,q4m,q50,p1m,p2m,p3m,p4m,p50,beta,epsi,h1111011110)
call hamiltonian(q10,q2m,q3m,q4m,q5m,p1m,p2m,p3m,p4m,p5m,beta,epsi,h0111111111)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p1m,p2m,p3m,p4m,p5m,beta,epsi,h1111111111)
call hamiltonian(q10,q20,q30,q40,q50,p10,p20,p30,p40,p50,beta,epsi,h0000000000)
call hamiltonian(q1m,q20,q30,q40,q50,p10,p20,p30,p40,p50,beta,epsi,h1000000000)
call hamiltonian(q10,q20,q30,q40,q5m,p10,p20,p30,p40,p5m,beta,epsi,h0000100001)
call hamiltonian(q1m,q2m,q30,q40,q50,p10,p2m,p30,p40,p50,beta,epsi,h1100001000)
call hamiltonian(q10,q20,q30,q4m,q5m,p10,p20,p30,p4m,p5m,beta,epsi,h0001100011)
call hamiltonian(q1m,q2m,q3m,q40,q50,p10,p2m,p3m,p40,p50,beta,epsi,h1110001100)
call hamiltonian(q10,q20,q3m,q4m,q5m,p10,p20,p3m,p4m,p5m,beta,epsi,h0011100111)
call hamiltonian(q1m,q2m,q3m,q4m,q50,p10,p2m,p3m,p4m,p50,beta,epsi,h1111001110)
call hamiltonian(q10,q2m,q3m,q4m,q5m,p10,p2m,p3m,p4m,p5m,beta,epsi,h0111101111)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p10,p2m,p3m,p4m,p5m,beta,epsi,h1111101111)
...
call hamiltonian(q10,q20,q30,q40,q50,p10,p2m,p30,p40,p50,beta,epsi,h0000001000)
call hamiltonian(q10,q2m,q30,q40,q50,p10,p2m,p30,p40,p50,beta,epsi,h0100001000)
call hamiltonian(q1m,q20,q30,q40,q50,p1m,p2m,p30,p40,p50,beta,epsi,h1000011000)
call hamiltonian(q10,q2m,q3m,q40,q50,p10,p2m,p3m,p40,p50,beta,epsi,h0110001100)
call hamiltonian(q1m,q20,q30,q40,q5m,p1m,p2m,p30,p40,p5m,beta,epsi,h1000111001)
call hamiltonian(q10,q2m,q3m,q4m,q50,p10,p2m,p3m,p4m,p50,beta,epsi,h0111001110)
call hamiltonian(q1m,q20,q30,q4m,q5m,p1m,p2m,p30,p4m,p5m,beta,epsi,h1001111011)
call hamiltonian(q10,q2m,q3m,q4m,q5m,p10,p2m,p3m,p4m,p5m,beta,epsi,h0111101111)
call hamiltonian(q1m,q20,q3m,q4m,q5m,p1m,p2m,p3m,p4m,p5m,beta,epsi,h1011111111)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p1m,p2m,p3m,p4m,p5m,beta,epsi,h1111111111)
!call hamiltonian(q10,q20,q30,q40,q50,p10,p20,p30,p40,p50,beta,epsi,h0000000000)
call hamiltonian(q10,q2m,q30,q40,q50,p10,p20,p30,p40,p50,beta,epsi,h0100000000)
call hamiltonian(q1m,q20,q30,q40,q50,p1m,p20,p30,p40,p50,beta,epsi,h1000010000)
call hamiltonian(q10,q2m,q3m,q40,q50,p10,p20,p3m,p40,p50,beta,epsi,h0110000100)
call hamiltonian(q1m,q20,q30,q40,q5m,p1m,p20,p30,p40,p5m,beta,epsi,h1000110001)
call hamiltonian(q10,q2m,q3m,q4m,q50,p10,p20,p3m,p4m,p50,beta,epsi,h0111000110)
call hamiltonian(q1m,q20,q30,q4m,q5m,p1m,p20,p30,p4m,p5m,beta,epsi,h1001110011)
call hamiltonian(q10,q2m,q3m,q4m,q5m,p10,p20,p3m,p4m,p5m,beta,epsi,h0111100111)
call hamiltonian(q1m,q20,q3m,q4m,q5m,p1m,p20,p3m,p4m,p5m,beta,epsi,h1011110111)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p1m,p20,p3m,p4m,p5m,beta,epsi,h1111110111)
...
call hamiltonian(q10,q20,q30,q40,q50,p10,p20,p3m,p40,p50,beta,epsi,h0000000100)
call hamiltonian(q10,q20,q3m,q40,q50,p10,p20,p3m,p40,p50,beta,epsi,h0010000100)
call hamiltonian(q10,q2m,q30,q40,q50,p10,p2m,p3m,p40,p50,beta,epsi,h0100001100)
call hamiltonian(q10,q20,q3m,q4m,q50,p10,p20,p3m,p4m,p50,beta,epsi,h0011000110)
call hamiltonian(q1m,q2m,q30,q40,q50,p1m,p2m,p3m,p40,p50,beta,epsi,h1100011100)
call hamiltonian(q10,q20,q3m,q4m,q5m,p10,p20,p3m,p4m,p5m,beta,epsi,h0011100111)
call hamiltonian(q1m,q2m,q30,q40,q5m,p1m,p2m,p3m,p40,p5m,beta,epsi,h1100111101)
call hamiltonian(q1m,q20,q3m,q4m,q5m,p1m,p20,p3m,p4m,p5m,beta,epsi,h1011110111)
call hamiltonian(q1m,q2m,q30,q4m,q5m,p1m,p2m,p3m,p4m,p5m,beta,epsi,h1101111111)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p1m,p2m,p3m,p4m,p5m,beta,epsi,h1111111111)
!call hamiltonian(q10,q20,q30,q40,q50,p10,p20,p30,p40,p50,beta,epsi,h0000000000)
call hamiltonian(q10,q20,q3m,q40,q50,p10,p20,p30,p40,p50,beta,epsi,h0010000000)
call hamiltonian(q10,q2m,q30,q40,q50,p10,p2m,p30,p40,p50,beta,epsi,h0100001000)
call hamiltonian(q10,q20,q3m,q4m,q50,p10,p20,p30,p4m,p50,beta,epsi,h0011000010)
call hamiltonian(q1m,q2m,q30,q40,q50,p1m,p2m,p30,p40,p50,beta,epsi,h1100011000)
call hamiltonian(q10,q20,q3m,q4m,q5m,p10,p20,p30,p4m,p5m,beta,epsi,h0011100011)
call hamiltonian(q1m,q2m,q30,q40,q5m,p1m,p2m,p30,p40,p5m,beta,epsi,h1100111001)
call hamiltonian(q1m,q20,q3m,q4m,q5m,p1m,p20,p30,p4m,p5m,beta,epsi,h1011110011)
call hamiltonian(q1m,q2m,q30,q4m,q5m,p1m,p2m,p30,p4m,p5m,beta,epsi,h1101111011)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p1m,p2m,p30,p4m,p5m,beta,epsi,h1111111011)
...
call hamiltonian(q10,q20,q30,q40,q50,p10,p20,p30,p4m,p50,beta,epsi,h0000000010)
call hamiltonian(q10,q20,q30,q4m,q50,p10,p20,p30,p4m,p50,beta,epsi,h0001000010)
call hamiltonian(q10,q20,q3m,q40,q50,p10,p20,p3m,p4m,p50,beta,epsi,h0010000110)
call hamiltonian(q10,q20,q30,q4m,q5m,p10,p20,p30,p4m,p5m,beta,epsi,h0001100011)
call hamiltonian(q10,q2m,q3m,q40,q50,p10,p2m,p3m,p4m,p50,beta,epsi,h0110001110)
call hamiltonian(q1m,q20,q30,q4m,q5m,p1m,p20,p30,p4m,p5m,beta,epsi,h1001110011)
call hamiltonian(q1m,q2m,q3m,q40,q50,p1m,p2m,p3m,p4m,p50,beta,epsi,h1110011110)
call hamiltonian(q1m,q2m,q30,q4m,q5m,p1m,p2m,p30,p4m,p5m,beta,epsi,h1101111011)
call hamiltonian(q1m,q2m,q3m,q40,q5m,p1m,p2m,p3m,p4m,p5m,beta,epsi,h1110111111)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p1m,p2m,p3m,p4m,p5m,beta,epsi,h1111111111)
!call hamiltonian(q10,q20,q30,q40,q50,p10,p20,p30,p40,p50,beta,epsi,h0000000000)
call hamiltonian(q10,q20,q30,q4m,q50,p10,p20,p30,p40,p50,beta,epsi,h0001000000)
call hamiltonian(q10,q20,q3m,q40,q50,p10,p20,p3m,p40,p50,beta,epsi,h0010000100)
call hamiltonian(q10,q20,q30,q4m,q5m,p10,p20,p30,p40,p5m,beta,epsi,h0001100001)
call hamiltonian(q10,q2m,q3m,q40,q50,p10,p2m,p3m,p40,p50,beta,epsi,h0110001100)
call hamiltonian(q1m,q20,q30,q4m,q5m,p1m,p20,p30,p40,p5m,beta,epsi,h1001110001)
call hamiltonian(q1m,q2m,q3m,q40,q50,p1m,p2m,p3m,p40,p50,beta,epsi,h1110011100)
call hamiltonian(q1m,q2m,q30,q4m,q5m,p1m,p2m,p30,p40,p5m,beta,epsi,h1101111001)
call hamiltonian(q1m,q2m,q3m,q40,q5m,p1m,p2m,p3m,p40,p5m,beta,epsi,h1110111101)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p1m,p2m,p3m,p40,p5m,beta,epsi,h1111111101)
...
call hamiltonian(q10,q20,q30,q40,q50,p10,p20,p30,p40,p5m,beta,epsi,h0000000001)
call hamiltonian(q10,q20,q30,q40,q5m,p10,p20,p30,p40,p5m,beta,epsi,h0000100001)
call hamiltonian(q10,q20,q30,q4m,q50,p10,p20,p30,p4m,p5m,beta,epsi,h0001000011)
call hamiltonian(q1m,q20,q30,q40,q5m,p1m,p20,p30,p40,p5m,beta,epsi,h1000110001)
call hamiltonian(q10,q20,q3m,q4m,q50,p10,p20,p3m,p4m,p5m,beta,epsi,h0011000111)
call hamiltonian(q1m,q2m,q30,q40,q5m,p1m,p2m,p30,p40,p5m,beta,epsi,h1100111001)
call hamiltonian(q10,q2m,q3m,q4m,q50,p10,p2m,p3m,p4m,p5m,beta,epsi,h0111001111)
call hamiltonian(q1m,q2m,q3m,q40,q5m,p1m,p2m,p3m,p40,p5m,beta,epsi,h1110111101)
call hamiltonian(q1m,q2m,q3m,q4m,q50,p1m,p2m,p3m,p4m,p5m,beta,epsi,h1111011111)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p1m,p2m,p3m,p4m,p5m,beta,epsi,h1111111111)
!call hamiltonian(q10,q20,q30,q40,q50,p10,p20,p30,p40,p50,beta,epsi,h0000000000)
call hamiltonian(q10,q20,q30,q40,q5m,p10,p20,p30,p40,p50,beta,epsi,h0000100000)
call hamiltonian(q10,q20,q30,q4m,q50,p10,p20,p30,p4m,p50,beta,epsi,h0001000010)
call hamiltonian(q1m,q20,q30,q40,q5m,p1m,p20,p30,p40,p50,beta,epsi,h1000110000)
call hamiltonian(q10,q20,q3m,q4m,q50,p10,p20,p3m,p4m,p50,beta,epsi,h0011000110)
call hamiltonian(q1m,q2m,q30,q40,q5m,p1m,p2m,p30,p40,p50,beta,epsi,h1100111000)
call hamiltonian(q10,q2m,q3m,q4m,q50,p10,p2m,p3m,p4m,p50,beta,epsi,h0111001110)
call hamiltonian(q1m,q2m,q3m,q40,q5m,p1m,p2m,p3m,p40,p50,beta,epsi,h1110111100)
call hamiltonian(q1m,q2m,q3m,q4m,q50,p1m,p2m,p3m,p4m,p50,beta,epsi,h1111011110)
call hamiltonian(q1m,q2m,q3m,q4m,q5m,p1m,p2m,p3m,p4m,p50,beta,epsi,h1111111110)
