...
do 1 i=1d0,100d0,1d0
   ...
   2 call timestep(t,h)
	  ...
	  write(10,*)ft,fh,fs
	  write(*,*)count
	  call var(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,t,init,overt)
	  h=h/ratio
1 continue
pause
pause
...
subroutine initiala(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,t,init,overt,ratio,h,endt)
implicit none
real*8 q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,beta,epsi,t,init,overt,ratio,h,endt
beta=1d0
epsi=0d0
endt=1d4
h=0.05d0
...
subroutine var(q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,t,init,overt)
implicit none
real*8 q1,q2,q3,q4,q5,p1,p2,p3,p4,p5,t,init,overt
init=0d0
overt=0d0
t=0d0
q1=0.5d0
